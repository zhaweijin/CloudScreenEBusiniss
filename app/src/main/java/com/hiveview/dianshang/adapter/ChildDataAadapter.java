...
public class ChildDataAadapter extends BaseAdapter {
    private Context context;
    private List<ChildData> list;
    private int select_item;

    public ChildDataAadapter(Context context, List<ChildData> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        select_item= AreasSelectDialog.select_item_city;
        try{
