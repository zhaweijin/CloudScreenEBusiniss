...
public class OtherAuctionOrderdetailsAdapter extends BaseAdapter {
    ...
    public OtherAuctionOrderdetailsAdapter(Context context, List<OrderInfo> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        select_item= OtherAuctionOrderdetailsDialog.select_item;
        try{
