...
public class TipsDialog extends BDialog implements DialogInterface.OnDismissListener{
    ...
    public TipsDialog(Context context, ConfirmOnClickListener confirmOnClickListener) {
        super(context, R.style.CustomDialog);
        mContext = context;
        this.confirmOnClickListener = confirmOnClickListener;
        mFactory = LayoutInflater.from(mContext);
        mView = mFactory.inflate(R.layout.layout_tips_dialog, null);
